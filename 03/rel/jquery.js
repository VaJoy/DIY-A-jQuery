...
var 	slice$1 = arr$1.slice;
	...
	try {
		push.apply(arr$1 = slice$1.call(preferredDoc.childNodes), preferredDoc.childNodes);
		// Support: Android<4.0
		// Detect silently failing push.apply
		arr$1[preferredDoc.childNodes.length].nodeType;
	} catch (e) {
		push = { apply: arr$1.length ?
	...
	var selectorInit = function selectorInit(jQuery) {
	  jQuery.find = Sizzle;
	};
